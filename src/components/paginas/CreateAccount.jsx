    ...
    <div>
       ...
       <div className='flex justify-center'>
        ...
        <div className='flex justify-center items-center font-semibold mt-10'>
            <button className='bg-sky-900 text-white text-center px-16 py-3 rounded-xl shadow-2xl font-outfit hover:bg-sky-700 hover:text-white transition ease-in-out duration-300 '>Crear cuenta</button>
        </div>
        <Outlet />
       <Fondo_slate />
    </div>
